...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-blue-50">
            ...
            {/* Hero Section */}
            <section className="pt-16 pb-24 px-4 bg-gradient-to-b from-blue-50 to-purple-50">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <button
                            onClick={() => navigate('/signup')}
                            className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg text-lg shadow-lg transition-colors duration-300"
                        >
                            Join Our Community
                        </button>
                        <a
                            href="#resources"
                            className="bg-white hover:bg-gray-100 text-blue-600 px-6 py-3 rounded-lg text-lg shadow-md border border-blue-200 transition-colors duration-300"
                        >
                            Explore Resources
                        </a>
                    </div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-purple-50 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300">
                            ...
                            <a href="#" className="text-purple-600 font-medium hover:underline">View resources →</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 px-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <button
                        onClick={() => navigate("/signup")}
                        className="bg-white text-blue-600 hover:bg-blue-50 px-8 py-4 rounded-lg text-lg font-medium shadow-lg transition-colors duration-300"
                    >
                        Join Us Today
                    </button>
                </div>
